...
public class PrincipalClases {
    ...
    public static void mostrarVendedores(List<Object> vendedores){
        ...
        for (Object vendedor: vendedores) {
            CVendedor vd = (CVendedor) vendedores;
    ...
    public static void mostrarCliente(String nombre, String apellido, List<Object> objetos){
        ...
        if (obj instanceof CCliente)
            for (Object c : objetos) {
                CCliente cl = (CCliente) c; // Casting de datos
                if (cl.getNombres().equals(nombre) && cl.getApellidos().equals(apellido)) {
                    cl.mostrar();
                }
            }
        else if (obj instanceof CCliente)
            ...
            switch(opcionPrincipal){
                ...
                case 2:
                    ...
                    do {
                        CCliente cliente;
                        menuCliente();
                        opcionCliente = new Scanner(System.in).nextInt();
                        switch (opcionCliente) {
                            ...
                            case 1:  // Insertar // Crear
                                ...
                                break;
                            case 2: // Mostrar
                                System.out.println("  Menu Mostrar Cliente ");
                                System.out.println(" 0- Regresar al menu cliente");
                                System.out.println(" 1- Mostrar por posicion");
                                System.out.println(" 2- Mostrar por nombre y apellido");
                                System.out.println(" 3- Mostrar todas los clientes");
                                System.out.println("   Ingrese una opcion>>  ");
                                int opcionMostrarClientes = new Scanner(System.in).nextInt();
                            ...
                            case 3:  // Actualizar
                                ...
                                System.out.println(" 2- Actualizar todo");
                                System.out.println("   Ingrese una opcion>>  ");
                                int opcionActualizarCliente = new Scanner(System.in).nextInt();
                                    ...
                                    case 1:
                                        ...
                                        switch (campo){
                                            case "numero documento":
                                                System.out.println("Nuevo NumDocumento: ");
                                                cliente.setNumDocumento(new Scanner(System.in).nextLine());
                                                break;
                                            case "nombre":
                                                System.out.println("Nuevo Nombre: ");
                                                cliente.setNombres(new Scanner(System.in).nextLine());
                                                break;
                                            case "apellido":
                                                System.out.println("Nuevo Apellido: ");
                                                cliente.setApellidos(new Scanner(System.in).nextLine());
                                                break;
                                            case "tipo documento":
                                                System.out.println("Nuevo TipoDocumento: ");
                                                cliente.setTipoDocumento(String.valueOf(new Scanner(System.in).nextDouble()));
                                                break;
                                            case "correo":
                                                System.out.println("Nuevo Correo: ");
                                                cliente.setCorreo(new Scanner(System.in).nextLine());
                                                break;
                                            case "tipo":
                                                System.out.println("Nuevo Tipo: ");
                                                cliente.setTipo(new Scanner(System.in).nextLine());
                                                break;
                                            case "estado":
                                                System.out.println("Nuevo Estado: ");
                                                cliente.setEstado(new Scanner(System.in).nextLine());
                                                break;
                                        }
                                        break;
                                    case 2:
                ...
                case 3:
                    ...
                    do {
                        CVendedor vendedor;
                        menuVendedor();
                        opcionVendedor = new Scanner(System.in).nextInt();
                        switch (opcionVendedor) {
                            ...
                            case 2: // Mostrar
                                ...
                                System.out.println(" 3- Mostrar todas los clientes");
                                System.out.println("   Ingrese una opcion>>  ");
                                int opcionMostrarVendedores = new Scanner(System.in).nextInt();
                    ...
                    do{
                        ...
                        switch (opcionVentas){
                            ...
                            case 1: // Resgistrar una venta
                                ...
                                System.out.println("Ingrese el DNI del clinete:");
...
//                                }
    ...
    private static void mostrarClientes(String n, String a, List<Object> clientes) {
    }

    private static void mostrarVendedores(String n, String a, List<Object> clientes) {
    }
}
